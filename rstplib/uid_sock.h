...
int UiD_SocketInit(UID_SOCKET_T *sock, UID_SOCK_ID id,
		   TYPE_OF_BINDING binding);

int UiD_SocketRecvfrom(UID_SOCKET_T *sock, void *msg_buffer, int buffer_size,
		       UID_SOCKET_T *sock_4_reply);

int UiD_SocketSendto(UID_SOCKET_T *sock, void *msg_buffer, int buffer_size);
